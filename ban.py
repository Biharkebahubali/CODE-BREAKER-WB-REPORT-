# DEVELOPER BY @Code_Breaker
# 🔥 MODIFIED BY CODE BREAKER - REDMI EDITION 🔥
...
# ==========================================
# 🔥 CREDIT: @CODE_BREAKER | REDMI KILLER MODE
# ==========================================
...
def banner():
    print(f"{Fore.CYAN}\n🔥🔥🔥 CODE BREAKER - REDMI KILLER MODE 🔥🔥🔥{Style.RESET_ALL}")
    print(Fore.RED + r"""
   ⣴⣾⣿⣿⣶⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⢸⣿⣿⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠈⢿⣿⣿⣿⣿⠏⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
⠙⠻⠿⠿⠿⠿⠿⠟⠿⠿⠿⠇⠀⠀⠀⠀⠀⠻⠿⠿⠛⠛⠛
""" + Style.RESET_ALL)
    print(f"{Fore.CYAN}🔥🔥🔥 @CODE_BREAKER | REDMI KILLER MODE 🔥🔥🔥{Style.RESET_ALL}")
...
# ==========================================
# 🔥 MAIN MENU - CODE BREAKER EDITION 🔥
# ==========================================

while True:
    check_temp_expiry()
    banner()
    print(f"{Fore.RED}🔥🔥🔥 REDMI KILLER MODE 🔥🔥🔥{Style.RESET_ALL}")
    ...
    if choice == "1":
        ...
        print(f"{Fore.CYAN}👋 𝗘𝘅𝗶𝘁𝗶𝗻𝗴. 𝗦𝘁𝗮𝘆 𝘀𝗮𝗳𝗲, CODE BREAKER! 🔥")
        break
    else:
